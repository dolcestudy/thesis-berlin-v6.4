...
def get_car_list(vehicle_definitions_file: str) -> list:
    ...
    return [
        ...
        if vehicle.attrib["type"].endswith("car") or vehicle.attrib["type"].endswith("golf1.4")
    ]
...
def create_plan_file(input_file, output_file, vehicle_file, microcar_pct):
    ...
    for person in root.findall(".//person"):
        ...
        # skip car to microcar process if vehicle type is either mercedes or vwCaddy
...
if __name__ == "__main__":
    ...
    # setting
    input_file = r"input\v6.4\berlin-v6.4-3pct-plans-micro00pct-original.xml.gz"
    vehicle_id_file = r"utils\3pct_output_allVehicles.xml"
    output_file = [
